...
- Uses `gemini-flash-latest` as the primary conversation model, following Google's latest Flash alias updates automatically. Concrete fallback models remain available when the primary fails.
